...
#     def conv_block(in_channels, out_channels, kernel_size=4, stride=2, padding=1, normalize=True, dropout=0.0):
#         x = nn.Conv2d(out_channels,kernel_size, stride, padding)(in_channels)
#         x = nn.BatchNorm2d()(x)
#         x = nn.LeakyReLU(0.2, inplace=True)(x)
#         return x

#     def encoder_block(in_channels, out_channels):
#         x = nn.Conv2d(in_channels, out_channels)
#         p = nn.MaxPool2d((2,2))(x)
#         return x, p

#     def deconv_block(in_channels, skip_features, out_channels, kernel_size=4, stride=2, padding=1, dropout=0.0):
#         x = nn.ConvTranspose2d(out_channels, kernel_size, stride, padding)(in_channels)
#         x = nn.Concatenate()([x, skip_features])
